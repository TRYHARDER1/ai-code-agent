...
import com.dstarking.aicodeagent.mapper.ChatHistoryMapper;
...
public class ChatHistoryServiceImpl extends ServiceImpl<ChatHistoryMapper, ChatHistory>  implements ChatHistoryService{
    ...
    public boolean addChatMessage(Long appId, String message, String messageType, Long userId) {
        ...
        ThrowUtils.throwIf(message == null || message.isBlank(), ErrorCode.PARAMS_ERROR,"消息内容不能为空");
        ThrowUtils.throwIf(messageType == null || messageType.isBlank(), ErrorCode.PARAMS_ERROR,"消息类型不能为空");
        ...
        if (chatHistoryMessageTypeEnum == null) {
            ThrowUtils.throwIf(true, ErrorCode.PARAMS_ERROR, "消息类型无效");
        }
        ChatHistory chatHistory = ChatHistory.builder()
                .appId(appId)
                .message(message)
                .messageType(chatHistoryMessageTypeEnum.getValue())
                .userId(userId)
                .build();
